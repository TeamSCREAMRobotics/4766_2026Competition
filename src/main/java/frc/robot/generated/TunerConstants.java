...
public class TunerConstants {
      ...
      new TalonFXConfiguration()
          .withCurrentLimits(
              new CurrentLimitsConfigs()
                  ...
                  so we can set a relatively low stator current limit to help 
                  avoid brownouts without impacting performance. */
                  .withStatorCurrentLimit(Amps.of(60))
                  .withStatorCurrentLimitEnable(true));
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.410888671875);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.103271484375);
