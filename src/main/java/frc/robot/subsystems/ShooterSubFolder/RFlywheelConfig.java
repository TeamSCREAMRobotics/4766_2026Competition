...
public class RFlywheelConfig {
    public static final TalonFXSubsystemConfiguration RFLYWHEEL_CONFIG = new TalonFXSubsystemConfiguration();
    ...
    static{
        ...
        new TalonFXConstants(new CANDevice(ShooterConstants.RshooterMotorID), InvertedValue.CounterClockwise_Positive);
