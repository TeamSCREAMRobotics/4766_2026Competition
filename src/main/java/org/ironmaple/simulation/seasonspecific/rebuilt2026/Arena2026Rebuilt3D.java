...
public class Arena2026Rebuilt3D extends SimulatedArena3D implements Arena2026 {
  ...
  public void placeGamePiecesOnField() {
    System.out.println("Place running");
    ...
    double boundingBoxWidth =
        edu.wpi.first.units.Units.Inches.of(206).in(edu.wpi.first.units.Units.Meters);
    double boundingBoxDepth =
        edu.wpi.first.units.Units.Inches.of(72).in(edu.wpi.first.units.Units.Meters);
    ...
    double dividerWidth =
        edu.wpi.first.units.Units.Inches.of(2).in(edu.wpi.first.units.Units.Meters);
    double startX = dividerWidth / 2 + fuelSeparationGap + fuelRadius;
    double startY = dividerWidth / 2 + fuelSeparationGap + fuelRadius;

    this.fuelZoneCenter = new Translation2d(FIELD_WIDTH / 2, FIELD_HEIGHT / 2);
    ...
    GamePieceOnFieldSimulation3D.GamePieceInfo3D fuelInfo =
      ...
      for (int i = 0; i < 4; i++) {
        ...
        if (indices[i] < q.size()) {
          ...
          if (useAdvancedFuelPhysics) {
            ...
            piece =
                new GamePieceOnFieldSimulation3D(
                    this,
                    fuelInfo,
                    new Pose3d(
                        pos2d.getX(),
